...
## Element Plus Dialog - 弹窗拖拽

Element Plus Dialog 原生支持拖拽，无需注册自定义指令。设置 `draggable` 后可拖动弹窗标题栏；设置 `overflow` 后允许弹窗拖出浏览器可视区域。

### 使用方法

```vue
<template>
  <el-dialog draggable overflow title="可拖拽弹窗">
    弹窗内容
  </el-dialog>
</template>
```
...
<template>
  ...
  <el-dialog draggable overflow title="用户详情">
    <el-form>
